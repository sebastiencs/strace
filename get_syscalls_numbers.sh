...
cp $TEMPLATE_TYPES includes/types.h
echo "" >> includes/types.h
...
do
    ...
    if [ ! -e $TMP_DIR/$SYSCALL.proto ]; then
...
do
    echo -e "# define $typeid\t($I)" >> includes/types.h
    I=$((I+1))
done

echo -e "\r\033[Kdone"
echo -e "\n#endif /* !TYPES_H_ */" >> includes/types.h
echo -e "};\n\nsize_t\tg_size_tab = sizeof(g_syscalls) / sizeof(g_syscalls[0]);\n" >> $FILE_SYSCALLS
